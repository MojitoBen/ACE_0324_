import pymysql
from tkinter import Toplevel, Label, Entry, Button, ttk, filedialog, messagebox, Canvas
...
def calculate_window_size(root, window_width_percent, window_height_percent):
    # 獲取螢幕尺寸
...
def display_image_on_canvas(canvas, image_path, window_width, window_height):
